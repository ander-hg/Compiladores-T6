...
| ------------------- |
|O dano do ataque básico é 100. <br>
Os níveis de armadura e MR reduzem o dano recebido por 25%, 50% e 75% (respectivamente para "low", "medium" e "high"). <br>
Habilidades: <br>
 - Pierce - Quando ativada, substitui o ataque básico para causar 60 de dano que ignora qualquer tipo de resistencia do oponente. <br>
